...
%	\resumeItemListEnd
	...
	\resumeItem{Part of the scrum team, having daily standups and sprint reviews}
	\resumeItemListEnd
	...
	\resumeSubheading
	{Software Engineering Intern}{September 2018 -- January 2019}
	{Methylium B.V.}{The Hague, The Netherlands}
	\resumeItemListStart
...
%	\resumeSubHeadingListEnd
	...
	\resumeItem{Scores better on evaluation metrics compared to the baseline model}
	\resumeItemListEnd
	...
	\begin{itemize}[leftmargin=0.15in, label={}]
		\small{\item{
				\textbf{Programming Languages}{: C\#, TypeScript, Python, \LaTeX} \\
