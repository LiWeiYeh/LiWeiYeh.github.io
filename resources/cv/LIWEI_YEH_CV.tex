...
\begin{document}
    ...
    {ilionx B.V.}{Utrecht, The Netherlands}
%    \resumeItemListStart
%    \resumeItem{Implement features }\\
%    \resumeItem{Actively engaged with the product owner to maintain quality}\\
%    \resumeItem{Work in a high-pressure environment due to strict deadlines}\\
%    \resumeItem{Worked on projects for large companies such as ProRail, \\Port of Amsterdam, Open Universiteit}
%    \resumeItemListEnd
    ...
    \resumeItem{Developed robust unit tests using Test Driven Development}
	\resumeItem{Actively engaged with the product owner to maintain quality}\\
   	\resumeItem{Work in a high-pressure environment due to strict deadlines}\\
	\resumeItemListEnd
...
%	\resumeItem{Minored in Artificial Intelligence}
	...
	\begin{itemize}[leftmargin=0.15in, label={}]
		\small{\item{
				\textbf{Programming Languages}{: C\#, TypeScript, SQL} \\
